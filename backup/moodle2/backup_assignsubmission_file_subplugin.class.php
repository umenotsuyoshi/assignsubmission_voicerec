 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_assignsubmission_voicerec_subplugin extends backup_subplugin {
    ...
    protected function define_submission_subplugin_structure() {
        ...
        $subpluginelement = new backup_nested_element('submission_voicerec',
                                                      null,
        ...
        $subpluginelement->set_source_table('assignsubmission_voicerec',
                                            array('submission' => backup::VAR_PARENTID));

        // The parent is the submission.
        $subpluginelement->annotate_files('assignsubmission_voicerec',
