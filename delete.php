...
$url = new moodle_url('/mod/assign/submission/voicerec/delete.php');
...
$submission_plugin = $assignment->get_submission_plugin_by_type('voicerec');
...
if(!$found) {
    echo $OUTPUT->header();
    echo $OUTPUT->notification(get_string('nosuchfile', 'assignsubmission_voicerec'));
    ...
    if($confirm) {
        ...
        $confirmurl = new moodle_url('/mod/assign/submission/voicerec/delete.php');
        ...
        echo $OUTPUT->header();
        echo $OUTPUT->confirm(get_string('confirmdeletefile', 'assignsubmission_voicerec', $delpath.$delfile), $confirmurl, $viewurl);
    }
}