...
/**
 * The assignsubmission_voicerec assessable uploaded event.
 *
...
/**
 * The assignsubmission_voicerec assessable uploaded event class.
 *
 * @package    assignsubmission_voicerec
 * @since      Moodle 2.6
 * @copyright  2013 Frédéric Massart
...
class assessable_uploaded extends \core\event\assessable_uploaded {
    ...
    public static function get_name() {
        return get_string('eventassessableuploaded', 'assignsubmission_voicerec');
    }
