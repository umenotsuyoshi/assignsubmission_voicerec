...
/**
 * The assignsubmission_voicerec submission_created event.
 *
...
namespace assignsubmission_voicerec\event;

defined('MOODLE_INTERNAL') || die();

/**
 * The assignsubmission_voicerec submission_created event class.
 *
...
class submission_created extends \mod_assign\event\submission_created {
    ...
    protected function init() {
        parent::init();
        $this->data['objecttable'] = 'assignsubmission_voicerec';
    }
    ...
    public static function get_objectid_mapping() {
        // No mapping available for 'assignsubmission_voicerec'.
        return array('db' => 'assignsubmission_voicerec', 'restore' => \core\event\base::NOT_MAPPED);
    }
}
